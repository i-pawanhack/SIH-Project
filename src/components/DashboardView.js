      ...
      return `
        <tr style="cursor:pointer;" data-case-id="${c.id}">
          <td>
            ...
            <div style="font-size:0.75rem; color:var(--slate-500); font-family:var(--font-mono);">${window.tData(c.patient?.id || c.id)} • ${window.tData(c.patient?.age + "y")} (${window.tData(c.patient?.gender)})</div>
          </td>
          <td>
